...
//     uri: `https://api.thegraph.com/subgraphs/name/${subgraph}`,
...
//     baseQuery:fetchBaseQuery({baseUrl:'https://api.covalenthq.com/v1'}),
//     endpoints:(builder) =>({
//         getCovalentByName:builder.query({
//             query:  (q)=>   `${q}&key=${'ckey_6562db8ca22f481bb2d1ef24af0'}`
//         }),
//     }),
// })
// export const {UseGetCovalentByQuery} = covalentApi
