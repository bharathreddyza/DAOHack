  ...
  return (
    <div>
      {jobs?.map((job) => (
        <div
          key={job.value}
          className="card border rounded-md p-4 m-4  lg:w-1/2 "
        >
          <div className="justify-start">
            ...
            <h1 className="font-xl py-2 text-left">{job.description}</h1>
            <h1 className="font-xl py-2 text-left"> {job.amount}</h1>
            <h1></h1>
          </div>
        </div>
      ))}
